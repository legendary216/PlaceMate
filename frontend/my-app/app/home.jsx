...
          title="Logout"
          disabled={isLoggingOut} // 👈 DISABLES BUTTON
        >
          {isLoggingOut ? (
            <ActivityIndicator size="small" color="#4f46e5" /> // 👈 SHOW SPINNER
          ) : (
            <LogOut size={24} color="#4f46e5" /> // 👈 SHOW ICON
          )}
        </Pressable>
          </View>
