...
import { ArrowLeft, Loader2, Calendar, Clock, RefreshCw } from 'lucide-react';
    ...
    if (bookings.length === 0) {
      return (
        <div className="info-text empty-state">
          ...
          <p className="empty-subtitle">You haven't booked any sessions yet.</p>
    ...
    return (
      <div className="item-list">
        {bookings.map(booking => (
          <div key={booking._id} className="list-item booking-item">
             <img
